    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0A0A0F]">
      <div className="card max-w-md w-full border border-white/[0.12] p-8 shadow-2xl relative bg-[#13131F]/90 backdrop-blur-xl animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-zinc-400 mt-1">Set up your QR-Based Management System</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5" htmlFor="signup-name">
              Full Name
            </label>
            <div className="relative">
              <HiOutlineUser className="absolute left-3.5 top-1/2 -translate-y-1/2 text-zinc-500 text-lg" />
              <input
                type="text"
                id="signup-name"
                name="name"
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5" htmlFor="signup-email">
              Email Address
            </label>
            <div className="relative">
          ...
          <div>
            <label className="block text-xs font-semibold uppercase tracking-wider text-zinc-400 mb-1.5" htmlFor="signup-password">
              Password
            </label>
            <div className="relative">
